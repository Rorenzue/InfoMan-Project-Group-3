...
if (isset($_POST["next"])) {
    ...
    $_SESSION["PermanentAddress"] = $_POST["PermaStudAdd"]; 
    $_SESSION["CurrentAddress"] = $_POST["CurrentStudAdd"]; 
            ...
            <form method="POST" action="personalinfo.php">
                ...
                <div class="form-row">
                    ...
                    <select name="Sex" required>
                        ...
                        <option value="M" <?= (isset($_SESSION['Sex']) && $_SESSION['Sex'] === 'M') ? 'selected' : '' ?>>Male</option>
                        <option value="F" <?= (isset($_SESSION['Sex']) && $_SESSION['Sex'] === 'F') ? 'selected' : '' ?>>Female</option>
                    </select>
                ...
                <div class="form-row">
                    <input type="text" name="PermaStudAdd" placeholder="Permanent Student Address" required
                        value="<?= isset($_SESSION['PermanentAddress']) ? htmlspecialchars($_SESSION['PermanentAddress']) : '' ?>">
                    <input type="text" name="CurrentStudAdd" placeholder="Current Student Address" required
                        value="<?= isset($_SESSION['CurrentAddress']) ? htmlspecialchars($_SESSION['CurrentAddress']) : '' ?>">
                </div>
